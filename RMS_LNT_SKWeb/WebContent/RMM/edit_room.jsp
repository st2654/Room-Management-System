...
<s:form theme="simple" action="updateRoom">
<s:hidden name="room_id"/>
Room Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<s:textfield name="room_name"  label="Room Name"/><br><br>
Room Type&nbsp;&nbsp;-:<s:select list="roomType" name="room_type"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<% 
	...
	{ 
		...
		{	for(Facility tempCurFacList:currentFacList)
			...
			%>
			<tr><td><%=tempFac.getFacility_name() %></td><td><input type="text" name="fac<%=tempFac.getFacility_id()%>" value="<%=facValue%>"></td></tr>
			<%
...
<hr>
<u>Venue</u>:
<br>City&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<s:select list="{'Mumbai','Bangalore','Chennai'}" label="City" name="city"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Location&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<s:select list="{'Mahape','Airoli','Powai'}" label="Location" name="location"/><br>
<br>Block&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<s:textfield name="block" label="Block"/>
...
<br>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:submit align="center" name="create_room" label="Create Room" value="Update Details"/>&nbsp;&nbsp;&nbsp;
